...
object TrelloModel {
  ...
  case class Card(id: String, name: String, desc: String, idMembers: Seq[String], idChecklists: Seq[String])
  ...
  case class BoardList(id: String, name: String, cards: Seq[Card])
}
